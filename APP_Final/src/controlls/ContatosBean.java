...
public class ContatosBean {
	...
	public String insere() {
		...
		FacesContext.getCurrentInstance().addMessage(null, new FacesMessage	(FacesMessage.SEVERITY_INFO, "CONTATO INSERIDO COM SUCESSO!!!!", null));
	...
	public String editar(){
		...
		for(int i=0;i<repositorio.contatos.size();i++){
			...
			if(comp2 == comp1){
				...
				repositorio.contatos.get(i).setData(contato2.getData());
